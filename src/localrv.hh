...
public:
    ...
    /**@brief cinc: notify subscribers
     */
    void cinc_notifySubscribers(unsigned char type, StringSet& IIDs, unsigned char strategy, RemoteHostSet& sub, StringSet& SIDs) ;
    /**@brief cinc: notufy sub with the help of TM
     */
    void cinc_askTMforNotifySub(unsigned char type, StringSet& IIDs, unsigned char strategy, RemoteHostSet& sub, StringSet& SIDs) ;
    /**@brief cinc: this is the dedicated method for cinc subscription*/
    void cinc_subscrip_scope(RemoteHost*, String&, String&, unsigned char&, Packet*) ;
    /**@brief cinc: rendezous function: use TM to send request to cache routers or publishers
     */
    void cinc_rendezvous(unsigned char type, RemoteHostSet& publishers, RemoteHostSet& subscribers, StringSet& IIDs, StringSet SIDs, Packet* p) ;
    /**@brief cinc: when popularity hit the threshold, ask pub push content to cache router to cache*/
    void cinc_askPUBtocache(StringSet& SIDs, RemoteHostSet& publishers, String routerID) ;
    void cinc_operate_cache_list_entry(unsigned char type, StringSet& SIDs, Vector<String>& cache_router) ;
