...
public:
     ...
     */
    int proto_type;
    /**@brief cinc: ethernet protocol type for notifying the routers info
     */
    int notify_type ;
    /**@brief cinc: ethernet protocol type for request data from publisher*/
    int req_pub_type ;
    /**@brief cinc: ethernet protocol type for request data from cache router*/
    int req_router_type ;
    /**@brief cinc: ethernet protocol type for response from cache router*/
    int response_router_type ;
