...
public:
     ...
     */
    bool isScope;
    /** @brief cinc: the following three members are for content retrive
     *  rp_FID maps router ID or publisher ID to FID
     *  rp_type maps router ID or publisher ID to the content type
     *  rp_dis maps router ID or publisher ID to the distance
     *  rp_p2sfid maps router ID or publisher ID to the backward FID*/
    HashTable<String, BABitvector> rp_FID ;
    HashTable<String, unsigned char> rp_type ;
    HashTable<String, unsigned int> rp_dis ;
    HashTable<String, BABitvector> rp_p2sfid ;
};
